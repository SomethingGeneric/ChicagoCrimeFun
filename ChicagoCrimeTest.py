...
class ChicagoCrimeTest:
	...
	def test_add_dispatch(self, test_decision=False, num_items=None):
		...
		if (not test_decision):
			for i in range(num_items):
				...
				print("")
				print("Your priority queue returned - " + self.__chicago_crime_obj.get_dispatch_queue().dequeue())
				print("-----")
	...
	def test_decide_next_patrol(self, num_decisions=None):
		...
		for i in range(num_decisions):
			...
			print("We're going to send the next patrol out to : " + str(self.__chicago_crime_obj.decide_next_patrol()))
			print("-----")
		...
		for i in range(num_decisions):
			...
			if ((i % 3) == 0):
				...
				print("+++++")
				print("Requesting new patrol (number - " + str(i) + ")....")
				print("We're going to send the next patrol out to : " + self.__chicago_crime_obj.decide_next_patrol(dispatch))
				print("+++++")
	...
	def test_crime_priority_list(self):
		...
		for i in range(10):#for i in range(len(self.__chicago_crime_obj.get_crime_priority_list())):
			...
			print("This item has the following payload - " + str(self.__chicago_crime_obj.get_crime_priority_list()))
			print("-----")
